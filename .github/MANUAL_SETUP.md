...
3. Add `DEV_SSH_USER`.
4. Add `DEV_SSH_KEY`.
5. Add `DEV_S2SCRIPT_PLUGIN_DIR`.
6. Scope the SSH user to the remote staging path and Source2Script plugin directory.
7. Install Node.js 20 or newer on the SSH host and ensure `node` is available in
